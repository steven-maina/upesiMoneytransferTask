...
//            if (userlogged !=null){
//                model.addAttribute("error", "User already has another session");
//                return "login";
//            }
            // End Of Validate Password.
        } else if(getEmailInDatabase == null ){
            model.addAttribute("error", "Account by this Email does not exist, please create one first and try to login");
            return "login";
        }
        else{
