...
import com.TransferJavaTask.helpers.HTML;
import com.TransferJavaTask.helpers.Token;
import com.TransferJavaTask.mailMessenger.MailMessenger;
...
public class RegisterController {
    ...
    public ModelAndView register(@Valid @ModelAttribute("registerUser")User user,
        ...
        if(getEmailInDatabase != null ){
            registrationPage.addObject("error", "Email already exists, please sign in");
            return registrationPage;
        }
        ...
        try {
            MailMessenger.htmlEmailMessenger("stevenmaina3131@gmail.com", email, "Verify Account", emailBody);

        }catch (Exception exception){
            System.out.println(" error ************** "+exception);
            String successMessage = "Error occured while trying to register, please try again later !";
            registrationPage.addObject("error", successMessage);
            return registrationPage;
        }
